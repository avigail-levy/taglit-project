    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 d-flex flex-column align-items-end text-end">
                ...
                <div class="footer-credit-side mt-auto pt-4">
                    <p class="mb-0">
                        <span class="powered-by-text"><?php the_field('footer_powered_text','option'); ?></span>
                        <?php 
                        $p_link = get_field('footer_powered_link','option'); 
                        if($p_link):
                        ?>
                            <a href="<?php echo esc_url($p_link['url']); ?>" target="<?php echo esc_attr($p_link['target'] ?: '_self'); ?>" class="credit-link">
